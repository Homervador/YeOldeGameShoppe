...
export const Game: Game[]= [
	{ id:1 , name:'Mario' , raite:5 , date_added:'2017-05-30' , prise:25 , editor:'Nintendo' , type:'plate-forme' , 
		platform:['NES', 'GameBoy', 'Nintendo64'] , quantity:2 , 
		...
		picture: , date_published:'1985' , PEGI:3 },
	{ id:2 , name:'Tetris' , raite:4.5 , date_added:'2017-04-16' , prise:15 , editor:'Divers' , type:'puzzle' , platform:'GameBoy' , quantity:1 , 
		...
		picture: , date_published:1984 , PEGI:3 },
	{ id:3 , name:'Donkey Kong' , raite:4 , date_added:'2017-11-12' , prise:20 , editor:'Nintendo' , type:['plate-forme', 'puzzle'], 
		platform:'GameBoy' , quantity:3 , description:'Donkey Kong est un jeu vidéo de plates-formes/puzzle sorti en 1994 sur Game Boy. Le jeu a été développé par Nintendo EAD et édité par Nintendo. Il est compatible avec les améliorations qu offre le Super Game Boy, accessoire permettant de jouer aux jeux Game Boy sur Super Nintendo. Il a inspiré la série de jeux lancée par Mario vs. Donkey Kong sur Game Boy Advance.' , 
		picture: , date_published:'1994' , PEGI:3 },
	{ id:4 , name:'Sonic' , raite:3.5 , date_added:'2017-06-15' , prise:23 , editor:'Sega' , type:'plate-forme' , platform:['Mega Drive','Master Systeme'] , quantity:2 , 
		...
		picture: , date_published:1991 , PEGI:3 },
	{ id:5 , name:'Pokemon Rouge' , raite:'5' , date_added:'2017-06-06' , prise:'17' , editor:'Game Freak' , type:'aventure' , platform:'Game Boy' , quantity:4 , 
		...
		picture: , date_published:1996 , PEGI:3 }
];